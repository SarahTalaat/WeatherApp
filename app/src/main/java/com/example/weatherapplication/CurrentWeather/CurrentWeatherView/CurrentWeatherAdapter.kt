...
class CurrentWeatherAdapter: RecyclerView.Adapter<CurrentWeatherAdapter.MyViewHolder_InAllProductsAdapter>  {
    ...
    var onAllProductsClickListenerInterface_Instance_InWeatherAdapter: OnCurrentWeatherClickListenerInterface

    public constructor(context_Instance_ConstructorParameter_InAllProductsAdapter: Context, productsArrayList_ConstructorParameter_InAllProductsAdapter: ArrayList<Products>, onAllProductsClickListenerInterfaceInstance_ConstructorParameter_InWeatherAdapter: OnCurrentWeatherClickListenerInterface){
        ...
        this.onAllProductsClickListenerInterface_Instance_InWeatherAdapter = onAllProductsClickListenerInterfaceInstance_ConstructorParameter_InWeatherAdapter
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder_InAllProductsAdapter, position: Int) {
        ...
        holder.btn_addToFavourite_allProducts.setOnClickListener(){
            onAllProductsClickListenerInterface_Instance_InWeatherAdapter.onClick_insertProductToFavouriteProductsActivity_InOnProductClickListenerInterface(productsArrayList_InAllProductsAdapter.get(position))
        }
