...
import com.example.weatherapplication.Model.CurrentWeatherModel.APIModel.Converters
import com.example.weatherapplication.Model.CurrentWeatherModel.APIModel.Model_Forecast
import com.example.weatherapplication.Model.FavouriteCityModel.MyApplicationFavouriteCityModel.Model_FavouriteCity


@Database(entities = arrayOf(Model_FavouriteCity::class , Model_Time::class , Model_Forecast::class) , version = 6)
